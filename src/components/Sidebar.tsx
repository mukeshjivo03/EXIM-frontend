...
const SIDEBAR_SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/accounts/bank-loan/dashboard", label: "Finance Dashboard", icon: LayoutDashboard, modules: ["finance_dashboard"] },
      { to: "/accounts/bank-loan",  label: "Bank & Loan Accounts", icon: Landmark, modules: ["bank_accounts"] },
      { to: "/accounts/vendor-outstanding", label: "Vendor Outstanding", icon: Handshake,   modules: ["vendor_outstanding"] },
      { to: "/accounts/customer-outstanding", label: "Customer Outstanding", icon: UserCheck, modules: ["customer_outstanding"] },
      { to: "/accounts/customer-aging", label: "Customer Aging", icon: Clock, modules: ["customer_aging"] },
      { to: "/accounts/open-ars",   label: "Open ARs",          icon: ArrowUpRight, modules: ["open_ars"] },
      { to: "/accounts/open-aps",   label: "Open APs",          icon: ArrowDownLeft, modules: ["open_aps"] },
      { to: "/accounts/open-pos",   label: "Open POs",          icon: FileText, modules: ["open_pos"] },
