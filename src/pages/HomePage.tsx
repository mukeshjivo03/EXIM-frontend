...
const quickLinks: QuickLink[] = [
  ...
  { to: "/accounts/bank-loan/dashboard", label: "Finance Dashboard", icon: LayoutDashboard, desc: "Bank, FD & loan overview", category: "Commercials", modules: ["finance_dashboard"] },
  ...
  { to: "/accounts/customer-outstanding", label: "Customer Outstanding", icon: ReceiptText, desc: "Customer balance sheet", category: "Commercials", modules: ["customer_outstanding"] },
  { to: "/accounts/customer-aging", label: "Customer Aging", icon: Clock, desc: "Customer aging balance", category: "Commercials", modules: ["customer_aging"] },
  { to: "/accounts/open-ars", label: "Open ARs", icon: FileText, desc: "Open receivable invoices", category: "Commercials", modules: ["open_ars"] },
  { to: "/accounts/open-aps", label: "Open APs", icon: FileText, desc: "Open payable invoices", category: "Commercials", modules: ["open_aps"] },
  { to: "/accounts/open-pos", label: "Open POS", icon: FileText, desc: "Open purchase orders from SAP", category: "Commercials", modules: ["open_pos"] },
  ...
  { to: "/commodity/market-rates", label: "Market Rates", icon: CandlestickChart, desc: "Live commodity market rates", category: "Commercials", modules: ["dailyprice"] },
